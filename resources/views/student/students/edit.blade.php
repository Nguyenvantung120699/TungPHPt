...
@section("top_content")
    <div class="col-md-12">
        <div class="overview-wrap">
            <h2 class="title-1">Sửa thông tin sinh viên</h2>
        </div>
    </div>
@endsection
@section('main_content')
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{url("student/student/update",['id'=>$student->id])}}" method="post">
                    @csrf
                    <div class="form-group has-success">
                        <label for="cc-name" class="control-label mb-1">student name</label>
                        <input id="cc-name" name="student_name" type="text" value="{{$student->student_name}}"
                    ...
                    <div class="form-group has-success">
                        ...
                        <input id="cc-name" name="age" type="text" value="{{$student->age}}"
                    ...
                    <div class="form-group has-success">
                        ...
                        <input id="cc-name" name="telephone" type="text" value="{{$student->telephone}}"
                    ...
                    <div class="form-group has-success">
                        ...
                        <input id="cc-name" name="classRoom" type="text" value="{{$student->classRoom}}"
                    ...
                    <div class="form-group has-success">
                        <label for="cc-name" class="control-label mb-1">total mark</label>
                        <input id="cc-name" name="total_mark" type="text" value="{{$student->total_mark}}"
